...
//             <div className="absolute w-[94%] bottom-16 p-2.5 mt-2 flex bg-blue-300 items-center rounded-md px-4 duration-300 cursor-pointer bg-purple  hover:bg-blue-600 hover:bg-dark_purple">
//               {/* PROFILE */}
//               <NavLink
...
//               </NavLink>
//             </div>
//             <div className="absolute w-[94%] bottom-2 p-2.5 mt-2 flex bg-red-400 items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-red-600">
//               {/* END-TO-END PIPELINE */}
//               <button
      ...
      >
        <div className="text-gray-100 text-xl">
          ...
          <ul>
            ...
            >
              {/* END-TO-END PIPELINE ICON */}
              <div className="text-[15px] ml-4 text-gray-200">Analysis</div>
            </NavLink>
            <NavLink
              to={"/dashboard/pipeline"}
              className={({isActive}) =>
